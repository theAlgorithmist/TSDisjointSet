...
/**
 * Jest tests for the Typescript Math Toolkit disjoint set data structure
 */

import { TSMT$DSNode } from "../src/DSNodeImpl";

import "jest";
import {TSMT$DisjointSet} from "../src/DisjointSet";

const set: TSMT$DisjointSet = new TSMT$DisjointSet();

describe("DSNode Basic tests", () => {

  test('it constructs a new DSNode', () => {
  ...
  test('it constructs a new DSNode with provided key', () => {
    const node: TSMT$DSNode = new TSMT$DSNode('7');

    expect(node.key).toBe('7');
  });

  test('it clones a single node', () => {
    ...
    expect(node2.data['a']).toBe(1);
    expect(node2.data['b']).toBe(2);
    expect(node2.data['c']).toBe(3);
    expect(node2.next).toBe(null);
    expect(node2.parent).toBe(null);
  });

  test('it clones a linked set of nodes', () => {
    ...
    let node: TSMT$DSNode = node1.cloneSet();
    ...
    let next: TSMT$DSNode = <TSMT$DSNode> node.next;
    expect(next.key).toBe('2');

    next.key = 'two';
    expect(node2.key).toBe('2');

    next = <TSMT$DSNode> next.next;
  ...
  test('isEqual properly compares nodes', () => {
    const node1: TSMT$DSNode = new TSMT$DSNode();
    node1.key                = '1';
    node1.value              = 'one';
    node1.rank               = 3;
    ...
    let node2: TSMT$DSNode = node1.clone();
...
describe("Disjoint Set Basic Tests", () => {
  ...
  test('it constructs a new Disjoint Set', () => {
    expect(set.size).toBe(0);
    expect(set.find(null)).toBe(null);
    expect(set.copySet(null).length).toBe(0);
  });

  test('it correctly adds a collection of singleton nodes', () => {
    set.clear();
  ...
  test('it correctly adds an existing tree', () => {
    set.clear();
  ...
  test('find works from a collection of singletons', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.find(n);
    expect(n.isEqual(node)).toBe(true);
  });

  test('clones an empty forest', () => {
    set.clear();
  ...
  test('properly finds by ID from a set of singletons', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.findByID('1');
  ...
  test('copySet works with a singleton', () => {
    set.clear();
...
describe("Disjoint Set Advanced Tests", () => {
  ...
  test('it joins two singletons #1', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.find(n1);
    expect(node.key).toBe('1');
  ...
  test('it joins two singletons #2', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.find(n2);
  ...
  test('union returns gracefully with null inputs', () => {
    set.clear();
  ...
  test('find with path compression #1', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.find(n3);
    expect(node.key).toBe('1');
  ...
  test('it joins two trees of equal rank greater than one', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.find(n5);
    expect(node.key).toBe('1');
  });

  test('post-union set by ID', () => {
    set.clear();
  ...
  test('it joins two trees of non-equal rank greater than one', () => {
    set.clear();
  ...
  test('find by ID, arbitrary forest', () => {
    set.clear();
    ...
    let node: TSMT$DSNode = set.findByID('2');
    expect(node.key).toBe('2');
  ...
  test('it clones a forest', () => {
    ...
    // check immutability
    let node: TSMT$DSNode = clone.findByID('10');
    node.key              = 'c-10';
    expect(node.key).toBe('c-10');
    expect(n9.key).toBe('10');
  });

  test('multi-union test #2', () => {
    set.clear();
