...
import {TSMT$IDSNode} from "./DSNode";
...
export class TSMT$DSNode implements TSMT$IDSNode
{
  ...
  public parent: TSMT$IDSNode;      // parent reference
  public next: TSMT$IDSNode;        // next node in list (circularly wraps to root)
   ...
   *
   * @returns {boolean} True if the two nodes are considered equal.  Default test is equal {key} properties; subclass
   * and implement other logic as needed.
   */
